...
- `cron_changed`: observe Gateway-owned cron lifecycle changes as coalescible hints between `cron_reconciled` snapshots. Keep OpenClaw as the source of truth for due checks and execution.
